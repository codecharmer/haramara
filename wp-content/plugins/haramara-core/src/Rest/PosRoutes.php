 ...
 * with exact stock (which the public Store API deliberately hides), and
 * push-token registration for new-order alerts. Auth = WordPress Application
 * Passwords (Basic over HTTPS) resolving to a user with the `manage_haramara`
